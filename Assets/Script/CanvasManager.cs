namespace OpenCvSharp
{
    ...
    public class CanvasManager : MonoBehaviour
    {
        ...
        public void Button0()
        {
            ...
            SelectButton.transform.localPosition = new Vector3(-280, 205, 0);
        }
        public void Button1()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-160, 205, 0);
        }
        public void Button2()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-45, 205, 0);
        }
        public void Button3()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-280, 90, 0);
        }
        public void Button4()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-160, 90, 0);
        }
        public void Button5()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-45, 90, 0);
        }
        public void Button6()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-280, -25, 0);
        }
        public void Button7()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-160, -25, 0);
        }
        public void Button8()
        {
            SelectButton.enabled = true;
            SelectButton.transform.localPosition = new Vector3(-45, -25, 0);
        }
