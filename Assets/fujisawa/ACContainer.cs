...
public class AContainer 
{
    ...
    public AContainer(int id, bool SkipSetup = false, bool SkipSwap = false) {
        ...
        if (SkipSetup == true)
        {
            ...
            SetupDisp.Add(RotateDef.Blank);
            RSetupDisp.Add(RotateDef.Blank);
        }
        else
        {
            SetupDisp = setup;
